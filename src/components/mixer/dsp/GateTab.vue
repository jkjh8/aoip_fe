...
const PARAMS = [
  { key: 'threshold', i18nKey: 'dsp.threshold', min: -60, max: 0, step: 1, unit: 'dB' },
  { key: 'attackMs', i18nKey: 'dsp.attack', min: 0.1, max: 500, step: 0.1, unit: 'ms' },
  { key: 'holdMs', i18nKey: 'dsp.hold', min: 0, max: 2000, step: 1, unit: 'ms' },
  { key: 'releaseMs', i18nKey: 'dsp.release', min: 1, max: 5000, step: 10, unit: 'ms' },
  { key: 'rangeDb', i18nKey: 'dsp.range', min: -60, max: 0, step: 1, unit: 'dB' },
]
